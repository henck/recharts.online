...
import { IXAxis, DataFields } from '../Types';
import { forceRegex, forceRegexes } from '../Util';
import { Checkbox } from '@independent-software/typeui/controls/Checkbox';
import { PresentationEditor } from './PresentationEditor';

interface IXAxisEditorProps {
  className?: string;
  xaxis: IXAxis;
  onUpdate: (xaxis: IXAxis) => void;
}

class XAxisEditor extends React.Component<IXAxisEditorProps, IXAxis> {
  constructor(props: IXAxisEditorProps) {
    super(props);
    this.state = {...props.xaxis};
  }

  onChange = (data: IXAxis, forceupdate: boolean) => {
    forceRegexes(data, /^\d+$/, ["strokeWidth", "tickCount", "paddingLeft", "paddingRight", "tickSize", "minTickGap"]); 
    ...
    return (
      <div className={p.className}>
        ...
        >
          <Form.Field
            name="active"
            control={<Checkbox checked={this.state.active} label="Include X-axis"/>}
              ...
              <Flex.Row>
                <Flex.Column width={1}>
                  <Form.Field
                    label="Padding left"
                    name="paddingLeft"
                    control={<Input placeholder="Left" type="text" fluid clearable/>}
                ...
                <Flex.Column width={1}>
                  <Form.Field
                    label="Right"
                    name="paddingRight"
                    control={<Input placeholder="Right" type="text" fluid clearable/>}
