...
import { IArea, DataFields } from '../Types';
...
class AreaEditor extends React.Component<IAreaEditorProps, IArea> {

  constructor(props: IAreaEditorProps) {
    super(props);
    this.state = {...props.area};
  }

  onChange = (data: IArea, forceupdate: boolean) => {
